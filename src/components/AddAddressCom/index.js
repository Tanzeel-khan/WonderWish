...
const AddAddressCom = ({ onPressBack, name, onChangeName, number, onChangeNumber, address, onChangeAddress, payment, onPressPayment, cart, totalAmount, onPressPlace, error }) => {
    return (
