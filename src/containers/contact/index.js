...
class Contact extends React.Component {
  ...
  sendEmail() {
    const {message, number, userData, file, SubError, MsgError} = this.state;
    ...
    if (!number.length) {
      ...
      axios
        ...
        .then(res => {
          Alert.alert(
            'Email Delivered',
            'your email delivered successfully we will response in 3 to 4 working hour',
          );
          this.setState({number: '', message: '', file: {}});
