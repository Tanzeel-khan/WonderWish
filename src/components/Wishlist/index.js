...
const WishList = ({ msg, onSelectAddress, data, totalAmount, onPressBack, onPressSubtract, onPressAdd, onPressDelete, onPressProceed }) => {
    return (
        <View style={{ flex: 1, width: "100%", alignItems: "center" }}>
            <View style={{ width: "85%", flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 20 }}>
                ...
                <View style={{ paddingVertical: 15, justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
                    <Icon name="heart"  style={{ color: Colors.White, fontSize: 18, textShadowColor: Colors.White, textShadowRadius: 1 }} />
                    <Text style={{ textAlign: "center", color: Colors.White, fontSize: 12, fontFamily: Fonts.Montserrat_SemiBold, letterSpacing: 1, textShadowColor: Colors.White, textShadowRadius: 2, paddingLeft: 10 }}>WISHLIST</Text>
                </View>
            ...
            {data.length ?
                ...
                <View style={{ flex: 1, width: "100%", justifyContent: "center", alignItems: "center" }}>
                    <Text style={{ fontFamily: Fonts.Montserrat_Light, color: Colors.White, fontSize: 15, }} numberOfLines={2}>Wishlist Empty</Text>
                </View>}
